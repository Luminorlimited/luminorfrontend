        ...
        <div className="container flex lg:flex-row flex-col items-start p-6 gap-6">
            <div className="space-y-6 max-w-[800px]">
                ...
                <div className="space-y-4">
                    <h3 className="text-xl font-semibold text-gray-900">Write about <b>{getProfileById?.data?.retireProfessional?.name?.firstName || getProfileById?.data?.client?.name?.firstName}</b></h3>
