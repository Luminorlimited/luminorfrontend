            ...
            >
              ...
              <div className="flex-1">
                <div className="flex justify-between items-center">
                  <h3 className="text-sm font-semibold">{getUser?.client?.name?.firstName || getUser?.retireProfessional?.name?.firstName} {getUser?.retireProfessional?.name?.lastName || getUser?.client?.name?.lastName}</h3>
